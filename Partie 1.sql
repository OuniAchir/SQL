/*se connecter à SQLPlus avec l'utilisateur système*/
connect system/psw
...
---table client
create table CLIENT (NUMCLIENT integer, CIV varchar2(3),NOM varchar2(50), PRENOM varchar2(50), DATENAISSANCE date,  ADRESSE varchar2(100), TELPROF varchar2(10), TELPRIV varchar2(10), FAX varchar2(10), 
constraint pk_client primary key(NUMCLIENT), constraint ck_civ check (CIV in ('M.','Mle', 'Mme')) );
/*vérifier la création*/
desc client;
/*ou bien*/
select table_name from tabs;
---table employe
create table EMPLOYE (NUMEMPLOYE integer, NOMEMP varchar2(50), PRENOMEMP varchar2(50), CATEGORIE varchar2(30), SALAIRE number, 
constraint ck_employe primary key(NUMEMPLOYE), constraint ck_categorie check(CATEGORIE in('Mécanicien','Assistant')));
---table MARQUE 
create table MARQUE (NUMMARQUE integer, MARQUE varchar2(50), PAYS varchar2(50),
constraint pk_marque primary key (NUMMARQUE));
---table modele
create table  MODELE (NUMMODELE integer, NUMMARQUE integer, MODELE varchar2(100),
...
---table vehicule
create table  VEHICULE (NUMVEHICULE integer, NUMCLIENT integer, NUMMODELE integer, NUMIMMAT varchar2(20), ANNEE varchar2(4),
...
---table  INTERVENTIONS 
create table INTERVENTIONS(NUMINTERVENTION integer, NUMVEHICULE integer, TYPEINTERVENTION varchar2(50), DATEDEBINTERV date, DATEFININTERV date,  COUTINTERV number,
...
desc employe
alter table employe add constraint ck_categorie_null check(categorie is not null);
...
alter table interventions enable constraint ck_dateinter exceptions into tableerreurs;
select status from user_constraints where table_name=upper('interventions');
